...
export const labTestApi = {
  ...
  checkTestAvailability: () =>
    `${baseUrl}/api/lab/user/tests/check-availability`,
};
...
export const labBookingApi = {
  ...
  getBookingDetails: (bookingId) =>
    `${baseUrl}/api/lab/user/booking/details?bookingId=${bookingId}`,
};
...
export const labManagementApi = {
  ...
  getLabAvailability: (labId) =>
    `${baseUrl}/api/lab/user/labs/${labId}/availability`,
};
...
export const handleApiError = (error) => {
  ...
  if (error.response) {
    ...
    return {
      error: true,
      message:
        error.response.data.message || "An error occurred with the server",
