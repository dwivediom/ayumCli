...
const Doctor = (props) => {
  ...
  return (
    <div className="mt-1 m-auto min-w-[100%]">
      <div className="p-4    break-normal   rounded-lg border  lg:min-h-[20rem] min-w-[100%] m-auto  border-cyan-700 shadow-md bg-gray-800  ">
        <a href="#" className="">
          <h5 className="mb-2 text-2xl font-bold tracking-tight overflow-hidden    break-normal w-[90%] text-white">
            {name}{" "}
          </h5>
          <h6 className="text-gray-100  border-solid inline p-1 border-cyan-500/40 rounded-full   border-[1px] ">
            {" "}
            <span className="m-1">{specialist}</span>{" "}
          </h6>
        </a>
        <div className="mt-2 ">
          {" "}
          <p className="mb-3 font-normal text-gray-400 dark:text-gray-400">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 text-cyan-600/60 inline h-6"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="grid  grid-cols-2 gap-1 mb-2">
          <div>
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 inline  text-cyan-600/60  h-6"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <p className="mb-3 inline ml-1   font-normal text-gray-400">
              {" "}
              {phone}
            </p>
          </div>
