...
const Doctor = (props) => {
  ...
  return (
    <div  className='mt-1 m-auto w-[100%] '><div className="p-4    break-normal  rounded-lg border   border-cyan-700 shadow-md bg-gray-800 ">
    <a href="#" className=''>
        <h5 className="mb-2 text-2xl font-bold tracking-tight overflow-hidden    break-normal w-[90%] text-white" >{name} </h5>
    ...
    <div className='mt-2 '> <p className="mb-3 font-normal text-gray-400 dark:text-gray-400">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
        ...
        <p className="mb-3 inline ml-1   font-normal text-gray-400"> {phone}</p>
        ...
        <p className="mb-3 inline ml-1   font-normal text-gray-400"> {timing}</p>
